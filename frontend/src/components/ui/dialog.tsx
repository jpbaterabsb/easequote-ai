...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Mobile-first: full screen with safe margins
        'fixed z-50 grid w-[calc(100%-2rem)] border-0 bg-white/95 backdrop-blur-md shadow-elegant-xl ring-1 ring-inset ring-gray-200/30 duration-300',
        // Position: centered on all screens
        'left-[50%] top-[50%] translate-x-[-50%] translate-y-[-50%]',
        // Mobile: smaller padding, max height with scroll
        'p-4 gap-2 rounded-xl max-h-[85vh] overflow-y-auto',
        // Desktop: larger padding, max width
        'sm:p-6 sm:gap-3 sm:max-w-lg sm:max-h-[90vh]',
        // Animations
